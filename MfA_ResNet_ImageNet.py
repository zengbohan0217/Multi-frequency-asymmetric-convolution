...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = MfA_Conv.MfA_Conv(inplanes, planes, high_L=3, high_S=1, low_L=3, low_S=3,
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = MfA_Conv.MfA_Conv(inplanes, planes, high_L=1, high_S=1, low_L=3, low_S=3)
        self.bn1 = nn.BatchNorm2d(planes * 4)
        self.conv2 = MfA_Conv.MfA_Conv(planes * 4, planes, high_L=3, high_S=1, low_L=3, low_S=3,
                                       high_stride=stride, low_stride=stride, basic_stride=stride)
        self.bn2 = nn.BatchNorm2d(planes * 4)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.conv1 = MfA_Conv.MfA_Conv_start(3, 16, high_L=5, high_S=3, low_L=7, low_S=5,
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion * 4:
            downsample = nn.Sequential(
                MfA_Conv.MfA_Conv(self.inplanes, planes * block.expansion, high_L=1, high_S=1, low_L=1, low_S=1,
                                       high_stride=stride, low_stride=stride, basic_stride=stride),
                nn.BatchNorm2d(planes * block.expansion * 4),
            )
