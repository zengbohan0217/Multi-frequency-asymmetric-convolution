...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1):
        ...
        self.conv1 = MfA_Conv.MfA_Conv(in_planes, planes, high_L=1, high_S=1, low_L=1, low_S=1)
        ...
        self.conv3 = MfA_Conv.MfA_Conv(planes * 4, planes * self.expansion, high_L=1, high_S=1, low_L=1, low_S=1)
